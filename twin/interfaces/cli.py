...
def main(argv: list[str] | None = None) -> None:
    ...
    pcrev.add_argument("--vault", default=None)
    ...
    pnsr.add_argument("--vault", default=None)
    ...
    pnscp.add_argument("--vault", default=None)
    ...
    pnsc.add_argument("--vault", default=None)
    ...
    pnsb.add_argument("--vault", default=None)
    ...
    pnsa.add_argument("--vault", default=None)
    ...
    pinp.add_argument("--vault", default=None)
