...
Goal: move from an on-demand observer toward a continuously updated extended-memory process inspired by the Global Workspace model. Natural consumer of [Correlation depth](#correlation-depth-planned-vx--after-phase-7): incremental correlation and episode-phase updates should feed consolidation without full rescans.
...
See also: conceptual bases in [FOUNDATIONS.md](FOUNDATIONS.md), how it is built in [ARCHITECTURE.md](ARCHITECTURE.md), and the short entry point in [README.md](../README.md).
